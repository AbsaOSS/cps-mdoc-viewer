...
import { ActiveLinkDirective, ListItem } from './directive/active-link.directive';
...
export class TableContentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.params.subscribe((params) => {
      ...
      this.tableContents$ = this.tableContentsService.getCategorizedTableContents(selectedDirectory);
    });
  }
}
